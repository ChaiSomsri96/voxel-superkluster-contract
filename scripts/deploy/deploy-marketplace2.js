...
async function main() {
    ...
    const marketplace = await hre.upgrades.upgradeProxy("0x04ee3A27D77AB9920e87dDc0A87e90144F6a278C", MARKETPLACE);
    console.log("marketplace upgraded" ,   marketplace.address);
